...
const CricketerPage = () => (
  <>
    <div className="cricketer-page-main-bg-container">
      <div className="cricketer-page-top-container">
        <div className="KL-rahul-description d-flex flex-column justify-content-center">
          ...
          <p className="cricketer-page-paragragh-01">
            Kannur Lokesh Rahul (born 18 April 1992), commonly known as KL
            Rahul, is an Indian international cricketer who plays....more
          </p>
        </div>
        <div>
          <img
        ...
        <div className="d-flex flex-row justify-content-center">
          <button className="btn btn-primary cricketer-page-button-01">
            View more
          </button>
        </div>
      </div>
      <div className="crickter-page-bottom-container">
        ...
        <div className="KXIP-vs-RCB-container d-flex flex-row justify-content-start">
          ...
          <div className="KXIP-vs-RCB-description-container d-flex flex-column justify-content-start">
            ...
            <p className="cricketer-page-paragragh-02">
              He scored an unbeaten 132 off just 69 balls againt Royal
              Challengers Bangalore....more
            </p>
          </div>
        </div>
        ...
        <div className="d-flex flex-row justify-content-between align-items-center back-navigate-button-container">
