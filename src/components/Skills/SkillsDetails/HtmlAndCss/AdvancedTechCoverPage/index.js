...
const AdvancedTechCard = () => (
  <div className="advanced-technologies-cover-page-main-bg-container d-flex flex-column justify-content-end">
    <div className="advanced-technologies-card-container d-flex flex-column justify-content-start">
